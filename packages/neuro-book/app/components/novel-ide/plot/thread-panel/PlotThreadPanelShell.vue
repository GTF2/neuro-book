...
<template>
    ...
    <aside class="z-10 flex h-full min-h-0 w-[340px] shrink-0 flex-col border-r border-[var(--border-color)] bg-[var(--panel-surface)] shadow-[0_28px_70px_color-mix(in_srgb,var(--shadow-color)_10%,transparent)]">
