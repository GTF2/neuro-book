...
import {
    ...
    StoryPromiseOverdueListDtoSchema,
...
export const routeMetaMap: RouteMetaEntry[] = [
    ...
    {
        file: "projects/plot/[...segments].ts",
        path: "projects/plot/promises/overdue",
        emitRouteMeta: false,
        method: "get",
        tags: ["Plot Promises"],
        summary: "List open reader promises overdue at the latest written chapter",
        queryParams: ProjectPlotProjectQuerySchema,
        responseBody: StoryPromiseOverdueListDtoSchema,
    },
    {
        file: "projects/plot/[...segments].ts",
